...
|---|---:|---|---|
| `RADAR_VERSION` | yes | `2.6.3` | Image/build version label |
...
- release notifications for users who enable email notifications; and
...
- SMTP host
- port
- STARTTLS, implicit TLS/SSL or no transport encryption
- username
- password
- timeout
- From email
...
- optional automatic analysis of newly detected releases
...
A tracker can also record where the software runs:

- currently installed version
- machine name
- IP address or hostname
- HTTP, HTTPS or TCP protocol
- service port
- health path
