...
ALLOWED_FINDINGS: dict[tuple[str, str, int], str] = {
    ...
    ("radar/inventory_providers.py", "B323", 111): "TLS verification bypass is an explicit opt-in for self-signed Dockhand and defaults to verification enabled.",
    ("radar/inventory_providers.py", "B310", 113): "Dockhand base URLs are validated as complete HTTP(S) URLs; local-network access is an intended integration feature.",
